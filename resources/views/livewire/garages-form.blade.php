<div>
    <!-- HEADER -->
    <x-mary-header title="Nova garagem" separator progress-indicator class="p-5"></x-mary-header>
    ...
    <div class="grid gap-4 grid-cols-1">
        ...
        <div class="grid gap-4 grid-cols-2">
            <div class="w-full">
                <x-mary-input label="{{ __('Capacidade de carros que comporta') }}" wire:model="capacidade" wire:model.lazy="capacidade" class="mb-4"/>
            </div>
        </div>
        <x-slot:actions>
            <x-mary-button label="Cancelar" link="{{ route('garages.index') }}" />
