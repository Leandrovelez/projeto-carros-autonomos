...
final class WarehousesList extends PowerGridComponent
{
    public string $tableName = 'warehouses';
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            //->add('created_at' , fn($entry) => Carbon::createFromFormat('d/m/Y', $entry->created_at)->format('d/m/Y'));
