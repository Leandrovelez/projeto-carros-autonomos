...
final class ColletionPointList extends PowerGridComponent
{
    public string $tableName = 'colletion-point-list-gg64r0-table';
    ...
    public function fields(): PowerGridFields
    {
        ...
        ->add('is_active', fn($entry) => $entry->is_active ? "Ativo" : "Inativo" );
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Responsável', 'nome_responsavel')
                ->searchable()
                ->sortable(),
            ...
            // Column::make('Data criação', 'created_at')
            //     ->searchable()
            //     ->sortable(),
    ...
    public function actions(ColletionPoint $row): array
    {
        return [
            Button::add('edit')
                ->slot('<x-mary-input> 
