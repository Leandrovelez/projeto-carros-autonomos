...
final class CarsOwnersList extends PowerGridComponent
{
    public string $tableName = 'cars-owners-list-myxd64-table';

    public function datasource(): Collection
    {
        $cars_owners = User::whereTipo('dono_de_carros')->get();

        return collect($cars_owners);
    }
